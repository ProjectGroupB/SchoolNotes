...
angular.module('core').controller('HeaderController', ['$scope', '$state', 'Authentication', 'Menus', 'ArtsubmissionsService', HeaderController]);
//HeaderController.$inject = ['ArtsubmissionsService'];

function HeaderController($scope, $state, Authentication, Menus, ArtsubmissionsService) {
